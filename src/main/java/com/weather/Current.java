...
public class Current{
	...
	public HashMap<String, Object> getAllCurrent() {
		HashMap<String, Object> newMap = new HashMap<>();
		newMap.put("feelslike_c", feelslikeC);
		newMap.put("uv", uv);
		newMap.put("lastUpdated", lastUpdated);
		newMap.put("feelslike_f", feelslikeF);
		newMap.put("windDegree", windDegree);
		newMap.put("lastUpdatedEpoch", lastUpdatedEpoch);
		newMap.put("isDay", isDay);
		newMap.put("precipIn", precipIn);
		newMap.put("windDir", windDir);
		newMap.put("gustMph", gustMph);
		newMap.put("tempC", tempC);
		newMap.put("pressureIn", pressureIn);
		newMap.put("gustKph", gustKph);
		newMap.put("tempF", tempF);
		newMap.put("precipMm", precipMm);
		newMap.put("cloud", cloud);
		newMap.put("windKph", windKph);
		newMap.put("condition", condition);
		newMap.put("windMph", windMph);
		newMap.put("visKm", visKm);
		newMap.put("humidity", humidity);
		newMap.put("pressureMb", pressureMb);
		newMap.put("visMiles", visMiles);
		return newMap;
	}
}